...
data = pd.DataFrame({
    'ID': np.arange(1, 501),
    'TV': np.random.uniform(10, 300, 500),         # Random TV budget
    'Radio': np.random.uniform(5, 50, 500),        # Random Radio budget
    'Newspaper': np.random.uniform(0, 100, 500),   # Random Newspaper budget
})
